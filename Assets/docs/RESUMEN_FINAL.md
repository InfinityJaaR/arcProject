...
1. [RESPUESTA_RAPIDA.md](./Assets/docs/RESPUESTA_RAPIDA.md)
2. [DIAGRAMA_VISUAL_BRUJULA.md](./Assets/docs/DIAGRAMA_VISUAL_BRUJULA.md)
3. [GUIA_CALIBRAR_BRUJULA.md](./Assets/docs/GUIA_CALIBRAR_BRUJULA.md)

**Para debugging:**
1. [GUIA_MAGNETOMETER_DIAGNOSTIC.md](./Assets/docs/GUIA_MAGNETOMETER_DIAGNOSTIC.md)

**Para entender la teoría:**
1. [EXPLICACION_NORTE_UNITY.md](./Assets/docs/EXPLICACION_NORTE_UNITY.md)
...
**Si tienes dudas, consulta: [INDICE_DOCUMENTACION_BRUJULA.md](./Assets/docs/INDICE_DOCUMENTACION_BRUJULA.md)**
